...
class HotelController extends Controller
{
    ...
    public function createCustomRecord($parameters)
    {
        ...
        if(isset($parameters['id']))
        {
            ...
            $attachments = AttachmentLibrary::getRecords($this->package, 'hotels-hotel', $parameters['id'], base_lang2()->id_001, true);

            // merge parameters and attachments array
            $parameters  = array_merge($parameters, $attachments);

            // get hotel products
            $parameters['hotelProducts']        = HotelProduct::getRecords(['hotel_id_177' => $parameters['id'], 'lang_id_177' => base_lang2()->id_001])->keyBy('product_id_177');
