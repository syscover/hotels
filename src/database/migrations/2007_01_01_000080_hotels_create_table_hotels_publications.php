...
class HotelsCreateTableHotelsPublications extends Migration {
	...
	public function up()
	{
        Schema::create('007_175_hotels_publications', function(Blueprint $table){
            ...
            $table->integer('hotel_id_175')->unsigned();
            $table->integer('publication_id_175')->unsigned();

            $table->primary(['hotel_id_175', 'publication_id_175'], 'pk01_007_175_hotels_publications');
        });
	}
