...
Route::group(['middleware' => ['auth.pulsar','permission.pulsar','locale.pulsar']], function() {
    ...
    |--------------------------------------------------------------------------
    */
    Route::any(config('pulsar.appName') . '/hotels/hotels/{lang}/{offset?}',                                  ['as'=>'Hotel',                    'uses'=>'Syscover\Hotels\Controllers\ServiceController@index',                      'resource' => 'hotels-hotel',        'action' => 'access']);
    Route::any(config('pulsar.appName') . '/hotels/hotels/json/data/{lang}',                                  ['as'=>'jsonDataHotel',            'uses'=>'Syscover\Hotels\Controllers\ServiceController@jsonData',                   'resource' => 'hotels-hotel',        'action' => 'access']);
    Route::get(config('pulsar.appName') . '/hotels/hotels/create/{lang}/{offset}/{id?}',                      ['as'=>'createHotel',              'uses'=>'Syscover\Hotels\Controllers\ServiceController@createRecord',               'resource' => 'hotels-hotel',        'action' => 'create']);
    Route::post(config('pulsar.appName') . '/hotels/hotels/store/{lang}/{offset}/{id?}',                      ['as'=>'storeHotel',               'uses'=>'Syscover\Hotels\Controllers\ServiceController@storeRecord',                'resource' => 'hotels-hotel',        'action' => 'create']);
    Route::get(config('pulsar.appName') . '/hotels/hotels/{id}/edit/{lang}/{offset}',                         ['as'=>'editHotel',                'uses'=>'Syscover\Hotels\Controllers\ServiceController@editRecord',                 'resource' => 'hotels-hotel',        'action' => 'access']);
    Route::put(config('pulsar.appName') . '/hotels/hotels/update/{lang}/{id}/{offset}',                       ['as'=>'updateHotel',              'uses'=>'Syscover\Hotels\Controllers\ServiceController@updateRecord',               'resource' => 'hotels-hotel',        'action' => 'edit']);
    Route::get(config('pulsar.appName') . '/hotels/hotels/delete/{lang}/{id}/{offset}',                       ['as'=>'deleteHotel',              'uses'=>'Syscover\Hotels\Controllers\ServiceController@deleteRecord',               'resource' => 'hotels-hotel',        'action' => 'delete']);
    Route::get(config('pulsar.appName') . '/hotels/hotels/delete/translation/{lang}/{id}/{offset}',           ['as'=>'deleteTranslationHotel',   'uses'=>'Syscover\Hotels\Controllers\ServiceController@deleteTranslationRecord',    'resource' => 'hotels-hotel',        'action' => 'delete']);
    Route::delete(config('pulsar.appName') . '/hotels/hotels/delete/select/records/{lang}',                   ['as'=>'deleteSelectHotel',        'uses'=>'Syscover\Hotels\Controllers\ServiceController@deleteRecordsSelect',        'resource' => 'hotels-hotel',        'action' => 'delete']);
