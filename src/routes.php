...
Route::group(['middleware' => ['auth.pulsar','permission.pulsar','locale.pulsar']], function() {
    ...
    */
    ...
    Route::get(config('pulsar.appName') . '/hotels/hotels/create/{lang}/{offset}/{id?}',                      ['as'=>'createHotel',              'uses'=>'Syscover\Hotels\Controllers\HotelController@createRecord',               'resource' => 'hotels-hotel',        'action' => 'create']);
    Route::post(config('pulsar.appName') . '/hotels/hotels/store/{lang}/{offset}/{id?}',                      ['as'=>'storeHotel',               'uses'=>'Syscover\Hotels\Controllers\HotelController@storeRecord',                'resource' => 'hotels-hotel',        'action' => 'create']);
    Route::get(config('pulsar.appName') . '/hotels/hotels/{id}/edit/{lang}/{offset}',                         ['as'=>'editHotel',                'uses'=>'Syscover\Hotels\Controllers\HotelController@editRecord',                 'resource' => 'hotels-hotel',        'action' => 'access']);
    Route::put(config('pulsar.appName') . '/hotels/hotels/update/{lang}/{id}/{offset}',                       ['as'=>'updateHotel',              'uses'=>'Syscover\Hotels\Controllers\HotelController@updateRecord',               'resource' => 'hotels-hotel',        'action' => 'edit']);
