                ...
                <div class="row">
                    <div class="col-md-3 card-image">
                        @if(isset($attachmentsProducts[$product->id_111]))
                            <img src="{{ asset(config('market.attachmentFolder') . '/' . $product->id_111 . '/' . $product->lang_id_112 . '/' . $attachmentsProducts[$product->id_111]->file_name_016) }}" class="img-respontive" style="max-height:200px;margin: 0 auto">
                        @endif
                    </div>
