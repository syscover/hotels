                ...
                <li{!! Miscellaneous::setCurrentOpenPage(['hotels-environment','hotels-decoration','hotels-relationship','hotels-service','hotels-publication','hotels-attachment-family']) !!}>
                    ...
                    <ul class="sub-menu" >
                        ...
                        @if(session('userAcl')->isAllowed(Auth::user()->profile_010, 'hotels-attachment-family', 'access'))
                            <li{!! Miscellaneous::setCurrentPage('hotels-attachment-family') !!}><a href="{{ route('CmsAttachmentFamily') }}"><i class="fa fa-picture-o"></i>{{ trans_choice('cms::pulsar.attachment_family', 2) }}</a></li>
                        @endif
                    </ul>
                </li>
            </ul>
